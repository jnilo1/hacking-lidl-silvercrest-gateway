...
echo "========================================="
echo "  BUILDING RTL8196E GATEWAY SYSTEM (BOARD=${BOARD:-lidl})"
echo "========================================="
echo ""
...
echo ""
echo "Built:"
[ $BUILD_BOOTLOADER -eq 1 ] && ls -lh "${SCRIPT_DIR}/31-Bootloader/boot-img/${BOARD:-lidl}/boot.bin" 2>/dev/null || true
