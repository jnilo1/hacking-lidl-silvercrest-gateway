...
/* Place plat_irq_dispatch in I-MEM when available (cannot use MIPS16: MFC0 ops) */
#ifdef CONFIG_RTL8196E_IMEM
#define __plat_iram __attribute__((section(".iram-gen")))
#else
#define __plat_iram
#endif
 ...
 */
asmlinkage __plat_iram void plat_irq_dispatch(void)
{
