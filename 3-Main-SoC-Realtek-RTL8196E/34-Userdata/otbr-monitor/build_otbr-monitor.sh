...
# ash loop in the system and the only process still exposed to the intermittent
# SIGSEGV/SIGILL/SIGBUS faults of the time (issue #109). Those were NOT an
# RLX4181 silicon defect, as this comment used to say: they were root-caused to
# our own TLB flush sweeping from a hardcoded index instead of the Wired
# boundary, and fixed. The rewrite stays for its own sake — no fork/exec per
# housekeeping cycle.
#
