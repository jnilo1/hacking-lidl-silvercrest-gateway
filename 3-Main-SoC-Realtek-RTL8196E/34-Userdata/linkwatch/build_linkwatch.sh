...
# keepalive / s40button — originally to keep a long-lived poll loop out of
# busybox ash (the issue #109 fault class, since root-caused to our own TLB
# flush and fixed); it stays C because such a loop forks nothing.
#
