#!/bin/bash
# flash_ezsp7.sh – Flash EZSP V7 firmware to Lidl/Silvercrest gateway
#
# Compatible with EZSP V7 (used with EmberZNet 6.5.0)
# Tested on EFR32MG1B232F256-based Lidl Silvercrest gateway
#
# Usage:
#   ./flash_ezsp7.sh <gateway_ip> <firmware.gbl>
#
# Requirements:
